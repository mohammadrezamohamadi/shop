...
$(document).ready(function () {
	...
	$("#sign-in-form").submit(function () {
		...
		if (value_login != "" && value_password != "") {
			...
			if (value_login == "") {
				...
				$(".error-message").text("نام کاربری یا رمز عبور را وارد نمایید.")
			} else if (value_login != "") {
				$('#ipt-login').removeClass('ipt-error')
			}
			if (value_password == "") {
	...
	$("#registration-form").submit(function () {
		...
		if (!email_values.test(value_email)) {
			...
			$('.error-box').slideDown('slow').removeClass('green').addClass('red');
			$(".error-message").text("لطفا ایمیل را صحیح وارد نمایید.");
			return false
		}
	...
	$("#forgotten-password-form").submit(function () {
		...
		if ((value_email != "") && (email_values.test(value_email))) {
			...
			$(".error-message").text("رمز عبور به آدرس ایمیل شما ارسال گردید.");
			return true
		} else {
			var value_email = $("#ipt-fp-email").val();
			if (value_email == "") {
				$('#ipt-fp-email').addClass('ipt-error');
				$('.error-box').slideDown('slow').removeClass('green').addClass('red');
				$(".error-message").text("لطفا ایمیل را وارد نمایید.")
